...
def start(self):
    try:
        ...
        spread_scale_factor = c_map.get("spread_scale_factor").value
        amount_scale_factor = c_map.get("amount_scale_factor").value
        ...
        self.strategy.init_params(
            ...
            spread_scale_factor=spread_scale_factor,
            amount_scale_factor=amount_scale_factor,
