...
fixed_grid_config_map = {
    ...
    "n_levels":
        ConfigVar(key="n_levels",
                  prompt="How many levels do you want on the fixed_grid (even number)? >>> ",
                  type_str="int",
    ...
    "order_amount":
        ConfigVar(key="order_amount",
                  ...
                  prompt_on_new=True),
    "spread_scale_factor":
        ConfigVar(key="spread_scale_factor",
                  prompt="Enter the grid spread scale factor",
                  type_str="decimal",
                  validator=lambda v: validate_decimal(v, min_value=Decimal("1"), inclusive=False),
                  default=Decimal("1")),
    "amount_scale_factor":
        ConfigVar(key="amount_scale_factor",
                  prompt="Enter the order amount scale factor",
                  type_str="decimal",
                  validator=lambda v: validate_decimal(v, min_value=Decimal("1"), inclusive=False),
                  default=Decimal("1")),
